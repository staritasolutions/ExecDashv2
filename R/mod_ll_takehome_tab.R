...
#' ll_takehome_tab Server Functions
#'
#' @noRd
  ...
  moduleServer( id, function(input, output, session){
    ...
    table_df <- reactive({
      learning_leader %>%
        ...
        ungroup() %>%
        mutate(`TH / Guest` = round(`TH $` / Guests, 2),
...
# mod_ll_takehome_tab_ui("ll_takehome_tab_1")

## To be copied in the server
# mod_ll_takehome_tab_server("ll_takehome_tab_1")
